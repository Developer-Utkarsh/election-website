...
const VideoThumbnail = ({ isMain = false }) => (
  <div className={`bg-neutral-500 rounded-lg relative ${isMain ? 'w-full h-96' : 'w-52 h-32'}`}>
  ...
  return (
    <div className="bg-[#f9f9f9] py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-primary text-4xl sm:text-5xl font-bold mb-8">Video Gallery</h2>
        <div className="flex flex-col lg:flex-row gap-6">
          <div className="lg:w-2/3">
            <VideoThumbnail isMain={true} />
            <div className="mt-12">
              <h3 className="text-4xl font-bold text-secondary mb-4">Economic Development</h3>
              <p className="text-gray-600">
                Nam id arcu facilisis nunc. Fusce tristique commodo justo id hendrerit. In nec vulputate justo
                dictumst. Quisque sit amet tortor sed tortor congue imperdiet ut id amet magna. Quisque ut viverra
                nisi.
              </p>
            </div>
          </div>

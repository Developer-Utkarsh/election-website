    ...
    <div className="flex flex-col lg:flex-row justify-between overflow-hidden w-full">
      <div className="w-full lg:w-1/2 bg-white py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-xl mx-auto lg:ml-auto lg:mr-0">
          ...
          <ScrollAnimation>
            <Link to="/about" className="mt-6 sm:mt-8 bg-blue-600 text-white font-semibold py-2 sm:py-3 px-4 sm:px-6 rounded-full hover:bg-blue-700 transition duration-300 inline-flex items-center text-sm sm:text-base">
              READ MORE
